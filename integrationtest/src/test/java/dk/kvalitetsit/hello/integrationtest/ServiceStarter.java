...
public class ServiceStarter {
    ...
    private static final Logger serviceLogger = LoggerFactory.getLogger("kiuthugs-pr");
    ...
    public GenericContainer startServicesInDocker() {
        ...
        var resourcesContainerName = "kiuthugs-pr-resources";
        ...
        if (resourcesRunning) {
            ...
            service = new GenericContainer<>("local/kiuthugs-pr-qa:dev")
        ...
        service.withNetwork(dockerNetwork)
                .withNetworkAliases("kiuthugs-pr")
